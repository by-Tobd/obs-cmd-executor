...
Autostart happens on obs startup and script reload.
...
def script_update(settings):
    ...
    for i in range(1, amount_of_commands+1):
        ...
        cmd["autostart"] = obs.obs_data_get_bool(settings, f"cmd_autostart_{i}")
...
def script_properties():
    ...
    for i in range(1, amount_of_commands+1):
        ...
        obs.obs_properties_add_bool(props, f"cmd_autostart_{i}", f"Command {i}: Autostart")
